...
class License {
    ...
    public $product_url = 'https://craftsmancoding.com/products/downloads/xls2modx/';
    public $plugin = 'XLS2MODX'; // item name from store
    public $setting = 'xls2modx.license_key';
    ...
    public function activate($license_key) {
        ...
        {
            $this->modx->log(\xPDO::LOG_LEVEL_INFO, 'Activated XLS2MODX License:' .print_r($response,true));
